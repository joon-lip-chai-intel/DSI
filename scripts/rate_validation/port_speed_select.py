...
parser.add_argument("-ps", "--portspeed", help="select the port speed (10g/25G/50G/100G", default="25",type=str)
args = parser.parse_args()



def main():
    if args.portspeed=="10":
        print ("-k 10")
    elif args.portspeed=="25":
        print ("-k 25")
    elif args.portspeed == "50":
        print ("-k 50")
    elif args.portspeed == "100":
        print ("-k 100")
    else:
        print (" ")
