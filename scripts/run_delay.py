...
parser.add_argument("-tdelay", "--tdelay", help="set delay in seconds", default=20,type=int)
args = parser.parse_args()

def main():
	print (f"##DSI_Delay_Waiting for {args.tdelay} seconds for driver to load.##")
	time.sleep(args.tdelay)
