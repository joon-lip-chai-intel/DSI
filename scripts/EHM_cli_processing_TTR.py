...
time.sleep(5)
command_cli = " source /home/NAC/rdk/iwa_rdk.env; nohup /home/NAC/rdk/bin/cli -k 1 < /fs3/ocelot/DSI/scripts/EHM_Show_Port_TTR.txt >> /fs3/Ocelot/DSI/bin/EHM_port_status.txt"
